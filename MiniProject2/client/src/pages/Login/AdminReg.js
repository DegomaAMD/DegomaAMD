...
//           return;
//       } else {
//         Axios.post('http://127.0.0.1:8000/api/Admin/register', formData)
//       .then((response) => {
...
//             <TextField className='textInput' value={formData.role}  type='text' placeholder='ADMIN' name='Admin' disabled/>
//           </div>
//         <div>
...
//           <Link className='button1' to={'/Admin/login'} style={{textDecoration:'none'}}>
